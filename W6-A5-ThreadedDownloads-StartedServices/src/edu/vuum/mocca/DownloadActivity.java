...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	Intent intent_IntentService = DownloadIntentService.makeIntent(this, handler, getUrlString());
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.   	
        	Intent intent_threadPoolService = ThreadPoolDownloadService.makeIntent(this, handler, getUrlString());
        	startService(intent_threadPoolService);
